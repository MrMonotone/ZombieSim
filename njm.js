...
// find and replace NJM with your initials (i.e. ABC)
...
NJM.prototype = new Entity();
NJM.prototype.constructor = NJM;
...
NJM.prototype.selectAction = function () 
{
...
NJM.prototype.calculateInterceptionPoint = function (target, targetVelocity, projSpeed) {
...
NJM.prototype.collide = function (other) {
    return distance(this, other) < this.radius + other.radius;
};

NJM.prototype.collideLeft = function () {
    return (this.x - this.radius) < 0;
};

NJM.prototype.collideRight = function () {
    return (this.x + this.radius) > 800;
};

NJM.prototype.collideTop = function () {
    return (this.y - this.radius) < 0;
};

NJM.prototype.collideBottom = function () {
    return (this.y + this.radius) > 800;
};

NJM.prototype.update = function () {
...
NJM.prototype.draw = function (ctx) {
    ctx.beginPath();
